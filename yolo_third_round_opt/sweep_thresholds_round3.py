...
def main():
    parser = argparse.ArgumentParser(description="Round 3 threshold sweep for YOLOv8.")
    ...
    parser.add_argument("--project", default="runs/third_round")
    parser.add_argument("--name", default="sweep_val_round3")
    parser.add_argument("--confs", default="0.01,0.05,0.10,0.15,0.20,0.25,0.30")
